<template>
    <section id="comm" class=" pt-16 pb-1 border-t bg-comcolor">
        <h1 class="mx-auto mb-10 font-bold text-center text-3xl sm:text-4xl">GET CONNECTED</h1>
        <div class="flex flex-col-reverse md:grid md:grid-cols-2 mx-auto max-w-md overflow-hidden px-[20px]  md:max-w-full mb-20">
            ...
            <div class="px-2 md:px-6 text-gray-950">
                ...
                <div class="py-4">
                    <span class="text-xl pr-3 font-bold">CULTURAL INTEGRATION: </span>
                    <p class="mt-2 ">
                ...
                <div class="py-4">
                    <span class="text-xl pr-3 font-bold">SUPPORT & ENCOURAGEMENT: </span>
                    <p class="mt-2">
            ...
            <!-- image -->
            <div class=" md:shrink-0 md:p-6">
                <img class="h-full max-w-full object-center  object-cover rounded-lg" src="../assets/images/fellowship.png" alt="community picture" />
            </div>
        </div>
    </section>
</template>
