<template>
    <section class=" mx-auto my-10 p-6 max-w-md md:max-w-full md:w-[90vw] rounded-lg font-medium">
        ...
        <ul class="list-disc list-inside px-10">
            ...
            <li>Creating a global network where they can connect, share experiences and build lasting relationships of mutual benefit in all ramifications.</li>
            <li>Offering resources and guidance for seamless cultural integration while upholding Christian values</li>
            <li>Providing a platform for mutual support, encouragement, and spiritual growth.</li>
        </ul>
    </section>
</template>